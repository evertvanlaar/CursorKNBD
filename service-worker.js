// service-worker.js
const VERSION = '3.1.139'; // Dit sturen we naar de Sheet
const CACHE_NAME = 'kalanera-cache-v3.1.139'; // Dit dwingt de code-update af
const IMAGE_CACHE = 'kalanera-images-v3.1.139'; // Afbeeldingen apart cachen voor snelheid
